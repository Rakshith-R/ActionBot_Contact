...
var dailyUsageServiceChart = {
  data: {
    labels: ["W", "T", "F", "S", "S", "M", "T"],
    series: [[1072, 2000, 983, 1772, 524, 616, 1095], [1299, 1124, 1738, 761, 1587, 1009, 1239], [703, 1881, 1289, 915, 1376, 891, 1146], [677, 1787, 765, 1247, 532, 1058, 1782]]
  },
  options: {
    showArea: true,
    lineSmooth: Chartist.Interpolation.cardinal({
...
var emailsSubscriptionChart = {
  data: {
    ...
    series: [[1084, 886, 640, 1560, 1106, 906, 652, 868, 1136, 1220, 1512, 1790], [577, 1650, 1490, 1237, 1891, 1218, 1408, 1266, 939, 1016, 1864, 1224], [1373, 2086, 2848, 1074, 1067, 2096, 2122, 2036, 2026, 2990, 1362, 1991]]
  },
  options: {
    stackBars: true,
...
module.exports = {
  ...
  dailySalesChart1: dailySalesChart1,
  dailyUsageServiceChart: dailyUsageServiceChart,
