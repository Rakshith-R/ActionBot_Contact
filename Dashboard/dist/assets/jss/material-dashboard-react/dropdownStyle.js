...
var dropdownStyle = function dropdownStyle(theme) {
  return {
    ...
    links: _defineProperty({
      ...
      width: "30px",
      height: "30px",
      color: _materialDashboardReact.grayColor[9],
      marginRight: "15px"
    }),
    linkText: _extends({
      zIndex: "4"
    ...
    dropdown: {
      borderRadius: "3px",
      border: "0",
      boxShadow: "0 2px 5px 0 rgba(" + (0, _materialDashboardReact.hexToRgb)(_materialDashboardReact.blackColor) + ", 0.26)",
      top: "100%",
      zIndex: "1000",
      minWidth: "160px",
      padding: "5px 0",
    ...
    dropdownItem: _extends({}, _materialDashboardReact.defaultFont, {
      ...
      color: _materialDashboardReact.grayColor[8],
      whiteSpace: "nowrap",
      height: "unset",
      minHeight: "unset",
      "&:hover": _extends({
